        ...
        <motion.div initial={{
          ...
          <div className="space-y-4">
            <WalletButton.Custom wallet="metamask">
              {({ ready, connect }: { ready: boolean; connect: () => void }) => {
                return (
                  <motion.button
                    // disabled={!ready}
                    whileHover={{
                    ...
                    className="bg-gray-700 hover:bg-gray-600 w-full p-4 rounded-lg flex items-center justify-between transition-colors">
            ...
            <motion.button whileHover={{
              ...
              scale: 0.98
            }} onClick={handleConnectAllWallets} className="bg-gray-700 hover:bg-gray-600 w-full p-4 rounded-lg flex items-center justify-between transition-colors">
              <div className="flex items-center">
